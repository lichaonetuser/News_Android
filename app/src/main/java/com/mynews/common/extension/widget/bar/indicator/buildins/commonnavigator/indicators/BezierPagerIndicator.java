package com.mynews.common.extension.widget.bar.indicator.buildins.commonnavigator.indicators;
...
import com.mynews.common.core.util.ArgbEvaluatorUtils;
import com.mynews.common.extension.widget.bar.indicator.FragmentContainerHelper;
import com.mynews.common.extension.widget.bar.indicator.buildins.UIUtil;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (mColors != null && mColors.size() > 0) {
            ...
            int color = ArgbEvaluatorUtils.INSTANCE.eval(positionOffset, currentColor, nextColor);
