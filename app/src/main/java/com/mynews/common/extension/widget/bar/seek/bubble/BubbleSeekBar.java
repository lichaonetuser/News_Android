package com.mynews.common.extension.widget.bar.seek.bubble;
...
import static com.mynews.common.extension.widget.bar.seek.bubble.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.mynews.common.extension.widget.bar.seek.bubble.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.mynews.common.extension.widget.bar.seek.bubble.BubbleSeekBar.TextPosition.SIDES;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.core_colorPrimary));
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.core_colorAccent));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSize(BubbleUtils.dp2px(80), widthMeasureSpec), height);
