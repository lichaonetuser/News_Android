...
public class FragmentContainerHelper {
    private List<IndicatorBar> mMagicIndicators = new ArrayList<IndicatorBar>();
    ...
    public FragmentContainerHelper(IndicatorBar magicIndicator) {
    ...
    public void attachMagicIndicator(IndicatorBar magicIndicator) {
        mMagicIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (IndicatorBar magicIndicator : mMagicIndicators) {
