...
import static com.mynews.common.core.browser.agent.ActionActivity.Action.ACTION_CAMERA;
...
public final class ActionActivity extends Activity {
    ...
    private void openRealFileChooser() {
        ...
        try {
            ...
            this.startActivityForResult(Intent.createChooser(i,
                    "File Chooser"), FileUpLoadChooserImpl.REQUEST_CODE);
    ...
    private void fileDataActionOver(int resultCode , Intent data) {
        if(mFileDataListener!=null){
            mFileDataListener.onFileDataResult(FileUpLoadChooserImpl.REQUEST_CODE, resultCode, data);
            mFileDataListener = null;
        }
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FileUpLoadChooserImpl.REQUEST_CODE) {
    ...
    private void realOpenCamera() {
        ...
        try {
            ...
            if (mFile == null) {
                mFileDataListener.onFileDataResult(FileUpLoadChooserImpl.REQUEST_CODE, Activity.RESULT_CANCELED, null);
                mFileDataListener = null;
                finish();
            }
            ...
            this.startActivityForResult(intent, FileUpLoadChooserImpl.REQUEST_CODE);
