...
package com.mynews.common.core.net.http.exception;
...
public class APIException extends Exception {
    ...
    public static boolean isOk(APIResponse apiResult) {
        if (apiResult == null)
            return false;
        if (apiResult.isOk() /*|| ignoreSomeIssue(apiResult.getStatus())*/)
            return true;
        else
            return false;
    }
    ...
    public static APIException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex.message = resultException.toString();
            return ex;
