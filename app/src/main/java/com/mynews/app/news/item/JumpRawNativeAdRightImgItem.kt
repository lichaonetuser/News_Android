...
import com.mynews.app.news.ad.gcmob.JumpRawAdManger
import com.mynews.app.news.ad.gcmob.JumpRawNativeAd
...
open class JumpRawNativeAdRightImgItem<Bean : INativeAdConfig>(mBean: Bean) : BaseItem<Bean, JumpRawNativeAdRightImgItem.ViewHolder>(mBean) {

    private var mNativeAd: INativeAd? = null

    override fun getLayoutRes() = R.layout.item_jumpraw_native_ad_right_img
