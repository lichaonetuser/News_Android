...
data class Image(
        ...
        override @Expose @SerializedName("type") @Setter("type") @Column var type: Int = 0,
        ...
        //多图数据
        @Expose @SerializedName("images") @Setter("images") @Column var images: ArrayList<ImageInfo> = arrayListOf(),
        @Expose @SerializedName("avatar_url") @Setter("avatar_url") @Column var avatarUrl: String = "",
        @Expose @SerializedName("image") @Setter("image") @Column var info: ImageInfo = ImageInfo(),
