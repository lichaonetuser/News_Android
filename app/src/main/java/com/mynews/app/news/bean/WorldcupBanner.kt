...
data class WorldcupBanner (
        ...
        override @Expose @SerializedName("style") @Setter("style") @Column(defaultExpr = "0") var style: Int = DataDictionary.BannerStyle.BANNER_STYLE_0.value,
        ...
        override @Expose @SerializedName("type") @Setter("type") @Column var type: Int = DataDictionary.NewsType.WORLDCUPBANNER.value,
        ...
        @Expose @SerializedName("items") var items: ArrayList<WorldcupBannerNews> = arrayListOf()
) : BaseNewsBean(
    ...
    companion object {
        @JvmField
        val CREATOR = PaperParcelWorldcupBanner.CREATOR
    }

    override fun describeContents() = 0

    override fun writeToParcel(dest: Parcel, flags: Int) {
        PaperParcelWorldcupBanner.writeToParcel(this, dest, flags)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (javaClass != other?.javaClass) return false
        other as WorldcupBanner
