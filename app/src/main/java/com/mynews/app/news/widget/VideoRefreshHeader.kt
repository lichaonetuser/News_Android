...
class VideoRefreshHeader: LinearLayout, RefreshHeader {
...
//        }
    ...
    private fun initView() {
        ...
        imageView = ImageView(context)
                .apply {
                    layoutParams = params
                    setBackgroundResource(R.drawable.video_pull_11)
                }
        addView(imageView)

        pullAnimRes = getAnimRes(R.array.frame_anim_video_refresh_pull)
        releaseAnimRes = getAnimRes(R.array.frame_anim_video_refresh_release)
    }
    ...
    fun play(array: IntArray, startFrame: Int) {
