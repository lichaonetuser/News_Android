 ...
 * 备注：
 */
class HomeActivity : BaseAdActivity(){
    private val TAG_MAIN_LIFE = "HomeActivity"
    ...
    private fun preInit() {
        ...
        ads_mask.layoutParams = ConstraintLayout.LayoutParams(
    ...
    private fun init() {
        ...
        if (findFragment(HomeFragment::class.java) == null) {
            loadRootFragment(R.id.container_layout, HomeFragment(), false, false)
        }
