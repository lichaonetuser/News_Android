package com.box.common.extension.widget.bar.indicator.buildins.circlenavigator;
 ...
 */
public class ColorCircleNavigator extends View implements IPagerNavigator {
    private int mRadius;
    ...
    public ColorCircleNavigator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void drawIndicator(Canvas canvas) {
        mPaint.setColor(mCircleSelectedColor);
        mPaint.setStyle(Paint.Style.FILL);
    ...
    public void setCircleSelectedColor(int circleSelectedColor) {
        mCircleSelectedColor = circleSelectedColor;
        invalidate();
    }
