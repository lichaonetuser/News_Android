...
public class DefaultWebCreator implements WebCreator {
    ...
    private ViewGroup createGroupWithWeb() {
        ...
        FrameLayout.LayoutParams mLayoutParams = new FrameLayout.LayoutParams(params.width, params.height);
    ...
    private View webLayout() {
        WebView webView = web();
        int index = mIWebLayout.getWebIndex();
        ViewGroup viewGroup = mIWebLayout.getLayout(webView);
        viewGroup.addView(webView, index, mIWebLayout.getWebLayoutParams());
        LogUtils.i(TAG, "add webview");
        this.mWebView = webView;
        return mIWebLayout.getRootLayout(this.mWebView);
    }
