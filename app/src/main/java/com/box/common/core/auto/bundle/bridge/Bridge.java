package com.box.common.core.auto.bundle.bridge;
...
public class Bridge {
    ...
    private static BridgeDelegate sDelegate = new BridgeDelegate(CoreApp.getInstance(), new SavedStateHandler() {
        @Override
        public void saveInstanceState(@NonNull Object target, @NonNull Bundle state) {
            AutoBundle.pack(target, state);
        }

        @Override
        public void restoreInstanceState(@NonNull Object target, @Nullable Bundle state) {
            if (state != null) {
                AutoBundle.bind(target, state);
            }
        }
    });
