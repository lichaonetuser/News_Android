package com.box.common.core.image.fresco;
...
import com.box.common.core.image.fresco.processors.BlurPostprocessor;
import com.box.common.core.image.fresco.util.ImageStreamTool;
...
public class ImageLoader {
    ...
    public static void loadImageBlur(final SimpleDraweeView draweeView, String url) {
        loadImage(draweeView, url, new BlurPostprocessor(draweeView.getContext()));
    }

    public static void loadImageBlur(final SimpleDraweeView draweeView, String url, final int reqWidth, final int reqHeight) {
        loadImage(draweeView, url, reqWidth, reqHeight, new BlurPostprocessor(draweeView.getContext()));
    }

    public static void loadFileBlur(final SimpleDraweeView draweeView, String filePath) {
        loadFile(draweeView, filePath, new BlurPostprocessor(draweeView.getContext()));
    }

    public static void loadFileBlur(final SimpleDraweeView draweeView, String filePath, final int reqWidth, final int reqHeight) {
        loadFile(draweeView, filePath, reqWidth, reqHeight, new BlurPostprocessor(draweeView.getContext()));
    }

    public static void loadDrawableBlur(SimpleDraweeView draweeView, int resId, final int reqWidth, final int reqHeight) {
        loadDrawable(draweeView, resId, reqWidth, reqHeight, new BlurPostprocessor(draweeView.getContext()));
    }

    public static void loadDrawableBlur(SimpleDraweeView simpleDraweeView, int resId) {
        loadDrawable(simpleDraweeView, resId, new BlurPostprocessor(simpleDraweeView.getContext()));
    }
            ...
            public void onNewResultImpl(DataSource<CloseableReference<PooledByteBuffer>> dataSource) {
                ...
                if (imageReference != null) {
                    ...
                    try {
                        ...
                        byte[] data = ImageStreamTool.read(inputStream);
                        ImageStreamTool.write(photoPath, data);
                        loadFileResult.onResult(photoPath);
                    } catch (Exception e) {
                        loadFileResult.onError(e);
                    } finally {
                        imageReference.close();
                        closeableReference.close();
                    }
