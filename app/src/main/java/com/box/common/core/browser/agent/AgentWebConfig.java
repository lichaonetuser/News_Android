...
public class AgentWebConfig {
    ...
    static final String AGENTWEB_CACHE_PATCH = File.separator + "browser_cache";
    static final String FILE_CACHE_PATH = "browser_cache";
    static String AGENTWEB_FILE_PATH;
    public static boolean DEBUG = false;
    static final boolean isKikatOrBelowKikat = Build.VERSION.SDK_INT <= 19;
