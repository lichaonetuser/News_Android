...
import kotlinx.android.synthetic.main.item_news_mutiple_3_pictures.view.*
 ...
 * Android 6.9 支持多图功能
 */
class MutiplePicture3Item(mBean: Image) : BasePictureItem<MutiplePicture3Item.ViewHolder>(mBean) {
    ...
    override fun getLayoutRes(): Int = R.layout.item_news_mutiple_3_pictures
...
//        }
        ...
        val bigImageHeight = screenWidth * if (isFavoriteStyle) RATIO_3_4 else RATIO_9_16
        val smallImageHeight = (bigImageHeight - MARGIN) / 2

        val bigImgParams = holder.newsImg0?.layoutParams as? ConstraintLayout.LayoutParams ?: return
        bigImgParams.height = bigImageHeight.toInt()
        bigImgParams.width = imageWidth

        val smallImgParams0 = holder.newsImg1?.layoutParams as? ConstraintLayout.LayoutParams ?: return
        smallImgParams0.height = smallImageHeight.toInt()
        smallImgParams0.width = imageWidth

        val smallImgParams1 = holder.newsImg2.layoutParams
        smallImgParams1.height = smallImageHeight.toInt()
        smallImgParams1.width = imageWidth
