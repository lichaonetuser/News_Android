...
class RelatedRightImgItem(mBean: BaseNewsBean) : BaseRelatedItem<BaseNewsBean, RelatedRightImgItem.ViewHolder>(mBean) {
    ...
    override fun getLayoutRes(): Int {
        return R.layout.item_related_article_right_img
    }
