...
data class WorldcupVideo (
        ...
        override @Expose @SerializedName("type") @Setter("type") @Column var type: Int = DataDictionary.NewsType.WORLDCUPVIDEO.value,
        ...
        @Expose @SerializedName("action_title") var action_title: String = "",
        @Expose @SerializedName("open_url") var open_url: String = "",
        @Expose @SerializedName("items") var video_items: ArrayList<Video> = arrayListOf(),
    ...
    companion object {
        @JvmField
        val CREATOR = PaperParcelWorldcupVideo.CREATOR
    }

    override fun describeContents() = 0

    override fun writeToParcel(dest: Parcel, flags: Int) {
        PaperParcelWorldcupVideo.writeToParcel(this, dest, flags)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (javaClass != other?.javaClass) return false
        other as WorldcupVideo
