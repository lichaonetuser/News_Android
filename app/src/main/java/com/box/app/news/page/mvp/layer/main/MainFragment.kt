...
import com.box.app.news.page.mvp.layer.main.MainTabEnum.NEWS
import com.box.app.news.page.mvp.layer.main.article.ArticleFragment
import com.box.app.news.page.mvp.layer.main.me.MeFragment
import com.box.app.news.page.mvp.layer.main.video.VideoFragment
import com.box.app.news.widget.navigation.MainBottomNavigationItemView
...
//                }
    ...
    override fun getCurrentTab(): IMainTab {
        ...
        return MainTabEnum.positionOf(selectedPosition)
    }
