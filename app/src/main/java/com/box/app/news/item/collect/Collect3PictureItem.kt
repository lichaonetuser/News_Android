...
import kotlinx.android.synthetic.main.item_news_collect_3_picture.view.*

/**
 * 收藏三张图片
 */
class Collect3PictureItem(mBean: Image)
    : BasePictureItem<Collect3PictureItem.ViewHolder>(mBean) {
    ...
    override fun createViewHolder(view: View, adapter: CommonRecyclerAdapter): Collect3PictureItem.ViewHolder {
        return Collect3PictureItem.ViewHolder(view, adapter)
    }

    override fun getLayoutRes() = R.layout.item_news_collect_3_picture
